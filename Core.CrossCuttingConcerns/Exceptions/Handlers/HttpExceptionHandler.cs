...
public class HttpExceptionHandler : ExceptionHandler
{
    ...
    //business hatası olduğunda program bunu middlewarede yakalayacak ve kulllanıcıya gösterecek.
    protected override Task HandleException(BusinessException businessException)
    {
        Response.StatusCode = StatusCodes.Status400BadRequest;
        string details = new BusinessProblemDetails(businessException.Message).AsJson();//AsJson metodu extension metottur.
